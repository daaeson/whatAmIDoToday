...
function SeoulList(){
    ...
    let html=seoulList.map((seoul,index)=>
        <li className={index%4==0?'one_quarter first':'one_quarter'}>
            <NavLink to={"/seoul/location_detail/"+seoul.no}>
                <img src={seoul.poster} title={seoul.title}/>
                <hr/>
                <p style={{"fontFamily":"IBMPlexSansKR-Regular","text-align":"center"}}>{seoul.title}</p>
            </NavLink>
        </li>
    )
    let row=[];
            ...
            <div className="wrapper row3">
                <main className="hoc container clear">
                    <div className="content">
                        <div id="gallery">
                            <figure>
                                <header className="heading" style={{"fontFamily":"IBMPlexSansKR-Regular"}}>서울의 곳곳</header>
